...
- **Descargar código fuente** (en sintaxis [Goku](https://github.com/yqrashawn/GokuRakuJoudo)). Ubicar el archivo en /Users/tu_usuario/.config/   y utilizar el comando goku para transpilarlo a un archivo de configuración válido
